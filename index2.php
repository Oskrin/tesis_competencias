				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<span class="red" id="id-text2">Aplicación Web </span>
								</h1>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="txt_1" id="txt_1" class="form-control" placeholder="Usuario" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="txt_2" id="txt_2" class="form-control" placeholder="Password" />
