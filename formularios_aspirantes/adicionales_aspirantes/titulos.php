...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into titulos values ('$cont','" .strtoupper($_POST['nombre_titulo']). "','" .$_POST['nivel_titulo']. "','" .$_POST['univ_titulo']. "','" .$_POST['fecha_titulo']. "','" .strtoupper($_POST['pais_titulo']). "','" .$_POST['area_titulo']. "','" .$_POST['reg_titulo']. "','1','$fecha','".$id_user."')";
