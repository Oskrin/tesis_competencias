...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into cursos values ('$cont','" .$_POST['tipo_curso']. "','" .strtoupper($_POST['nombre_curso']). "','" .$_POST['inst_curso']. "','" .$_POST['time_curso']. "','1','$fecha','".$id_user."')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update cursos set tipo_curso = '" .$_POST['tipo_curso']. "', nombre_curso = '" .strtoupper($_POST['nombre_curso']). "', inst_curso = '" .$_POST['inst_curso']. "', time_curso = '" .$_POST['time_curso']. "', fecha_creacion = '$fecha' where id_curso = '$_POST[id_curso]' and id_aspirante = '$id_user'";
        $guardar = guardarSql($conexion, $sql);
