...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into premios values ('$cont','" .strtoupper($_POST['nombre_premio']). "','" .$_POST['tipo_premio']. "','" .$_POST['motivo_premio']. "','1','$fecha','".$id_user."')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update premios set nombre_premio = '" .strtoupper($_POST['nombre_premio']). "', tipo_premio = '" .$_POST['tipo_premio']. "', motivo_premio = '" .$_POST['motivo_premio']. "', fecha_creacion = '$fecha' where id_premio = '$_POST[id_premio]' and id_aspirante = '$id_user'";
        $guardar = guardarSql($conexion, $sql);
