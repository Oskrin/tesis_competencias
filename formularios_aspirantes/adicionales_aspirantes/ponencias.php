...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into ponencias values ('$cont','" .strtoupper($_POST['nombre_ponencia']). "','" .$_POST['lugar_ponencia']. "','" .$_POST['fecha_ponencia']. "','1','$fecha','".$id_user."')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update ponencias set nombre_ponencia = '" .strtoupper($_POST['nombre_ponencia']). "', lugar_ponencia = '" .$_POST['lugar_ponencia']. "', fecha_ponencia = '" .$_POST['fecha_ponencia']. "', fecha_creacion = '$fecha' where id_ponencia = '$_POST[id_ponencia]' and id_aspirante = '$id_user'";
        $guardar = guardarSql($conexion, $sql);
