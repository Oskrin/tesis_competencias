...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into idiomas values ('$cont','" .strtoupper($_POST['nombre_idioma']). "','" .$_POST['nivel_lectura']. "','" .$_POST['nivel_escritura']. "','1','$fecha','".$id_user."')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update idiomas set nombre_idioma = '" .strtoupper($_POST['nombre_idioma']). "', nivel_lectura = '" .$_POST['nivel_lectura']. "', nivel_escritura = '" .$_POST['nivel_escritura']. "', fecha_creacion = '$fecha' where id_idioma = '$_POST[id_idioma]' and id_aspirante = '$id_user'";
        $guardar = guardarSql($conexion, $sql);
