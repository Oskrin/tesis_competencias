...
jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        ...
	        datatype: "xml",
	        height: 250,
	        colNames:['ID','CONCURSO','ID','CONVOCATORIA','ID','TRIBUNAL','CARGO CONCURSO','DETALLES','FECHA CREACIÓN'],
	        colModel:[
	            ...
	            {name:'id_convocatoria',index:'nombre_concurso',width:150, editable:true, hidden:true, editoptions:{maxlength:"100"}, editrules: {required: false}},
	            ...
	            {name:'id_tribunal',index:'id_tribunal',width:150, editable:true, hidden:true, editoptions:{maxlength:"100"}, editrules: {required: false}},
