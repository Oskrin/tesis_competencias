...
function menu_lateral(){	
	...
	print '<li ';if ($acus[3]=='idiomas' || $acus[3]=='cursos' || $acus[3]=='publicaciones' || $acus[3]=='titulos' || $acus[3]=='usuarios' || $acus[3]=='aspirantes' || $acus[3]=='docentes') {
	...
	print'<ul class="submenu">
		<li ';if ($acus[3]=='idiomas' || $acus[3]=='cursos') {
			...
			<ul class="submenu">';				
				...
				print '<li ';if ($acus[3]=='publicaciones') {
					print('class="active"');
				}print'>
					<a href="">
						<i class="menu-icon fa fa-caret-right"></i>
