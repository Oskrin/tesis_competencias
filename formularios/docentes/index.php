							...
							<div class="col-xs-12 col-sm-12 widget-container-col">
								<div class="widget-box">
									<div class="widget-header">
										<h5 class="widget-title"><i class="ace-icon fa fa-user"></i> DOCENTES</h5>
													...
													<div class="row">
														<div class="col-xs-12">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label class="col-sm-4 control-label no-padding-right" for="nombres"> Nombres: <font color="red">*</font></label>
																	<div class="col-sm-8">
																		<input type="text" id="nombres" name="nombres"  placeholder="Nombres Completos" class="form-control" data-toggle="tooltip" data-original-title="" required pattern="[0-9]{10,10}"/>																																																						
																	</div>
																</div>
															...
															<div class="col-sm-6">
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		<input type="text" id="ruc_ci" name="ruc_ci"  placeholder="Identificación Docente" class="form-control" data-toggle="tooltip" data-original-title="" required pattern="[0-9]{10,10}" maxlength="10" minlength="10" />																																																						
																	</div>
																</div>
		    ...
		    <div class="modal-dialog">
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title">BUSCAR DOCENTES</h4>
		        </div>
