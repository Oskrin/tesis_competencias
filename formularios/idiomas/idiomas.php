...
if ($_POST['oper'] == "add") {
    ...
    $repetidos = repetidos($conexion, "nombre_idioma", strtoupper($_POST['nombre_idioma']), "idiomas", "g", "", "");
    if ($repetidos == 'true') {
    ...
    if ($_POST['oper'] == "edit") {
        $repetidos = repetidos($conexion, "nombre_idioma", strtoupper($_POST['nombre_idioma']), "idiomas", "m", $_POST['id'], "id_idioma");
        if ($repetidos == 'true') {
            $data = "3"; /// este dato ya existe;
        } else {
