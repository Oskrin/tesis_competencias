...
function inicio () {
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({         
            ...
            editurl: 'premios.php?id_aspiraste=' + $("#validation-form").serialize(),
            caption: "PREMIOS"
        });
        $(window).triggerHandler('resize.jqGrid');//cambiar el tamaño para hacer la rejilla conseguir el tamaño correcto
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({         
            ...
            editurl: 'publicaciones.php?id_aspiraste=' + $("#validation-form").serialize(),
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({         
            ...
            editurl: 'experiencia.php?id_aspiraste=' + $("#validation-form").serialize(),
            caption: "EXPERIENCIA"
        });
        $(window).triggerHandler('resize.jqGrid');//cambiar el tamaño para hacer la rejilla conseguir el tamaño correcto
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({         
            ...
            editurl: 'titulos.php?id_aspiraste=' + $("#validation-form").serialize(),
            caption: "TITULOS"
        });
        $(window).triggerHandler('resize.jqGrid');//cambiar el tamaño para hacer la rejilla conseguir el tamaño correcto
