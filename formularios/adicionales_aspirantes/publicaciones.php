...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into publicaciones values ('$cont','" .strtoupper($_POST['nombre_publicacion']). "','" .$_POST['tipo_publicacion']. "','" .$_POST['lugar_publicacion']. "','" .$_POST['fecha_publicacion']. "','1','$fecha')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update publicaciones set nombre_publicacion = '" .strtoupper($_POST['nombre_publicacion']). "', tipo_publicacion = '" .$_POST['tipo_publicacion']. "', lugar_publicacion = '" .$_POST['lugar_publicacion']. "', fecha_publicacion = '" .$_POST['fecha_publicacion']. "', fecha_creacion = '$fecha' where id_publicacion = '$_POST[id_publicacion]'";
        $guardar = guardarSql($conexion, $sql);
