...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into proyectos values ('$cont','" .strtoupper($_POST['nombre_proyecto']). "','" .$_POST['cargo_proyecto']. "','" .$_POST['tiempo_proyecto']. "','1','$fecha')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update proyectos set nombre_proyecto = '" .strtoupper($_POST['nombre_proyecto']). "', cargo_proyecto = '" .$_POST['cargo_proyecto']. "', tiempo_proyecto = '" .$_POST['tiempo_proyecto']. "', fecha_creacion = '$fecha' where id_proyecto = '$_POST[id_proyecto]'";
        $guardar = guardarSql($conexion, $sql);
