...
if ($_POST['oper'] == "add") {
    ...
    $sql = "insert into experiencia values ('$cont','" .strtoupper($_POST['nombre_empresa']). "','" .$_POST['cargo_empresa']. "','" .$_POST['tiempo_empresa']. "','" .$_POST['contacto_empresa']. "','" .$_POST['referencia']. "','1','$fecha')";
    ...
    if ($_POST['oper'] == "edit") {
        $sql = "update experiencia set nombre_empresa = '" .strtoupper($_POST['nombre_empresa']). "', cargo_empresa = '" .$_POST['cargo_empresa']. "', tiempo_empresa = '" .$_POST['tiempo_empresa']. "', contacto_empresa = '" .$_POST['contacto_empresa']. "', referencia = '" .$_POST['referencia']. "', fecha_creacion = '$fecha' where id_experiencia = '$_POST[id_experiencia]'";
        $guardar = guardarSql($conexion, $sql);
